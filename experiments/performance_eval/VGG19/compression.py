...
def main(compression, net, dataset, learning_rate, lr_cumulative, minibatch, prfc, prcnn, clusterfc, clustercnn, tr, lambd, logger, ptnc):
    ...
    print("Setting initial compression before retrain, performance on train -->" , post_compr_train)
    print("Setting initial compression before retrain, performance on test -->" , post_compr_test)
